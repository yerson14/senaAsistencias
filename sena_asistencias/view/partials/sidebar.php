...
<aside id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-green-600 text-white overflow-y-auto transform -translate-x-full transition-transform duration-200 ease-in-out z-40">
    ...
    <nav class="mt-6">
        <ul>
            <li class="p-4 hover:bg-green-500"><a href="../superadmin/index.php">Inicio</a></li>
            <?php if ($_SESSION['usuario']['rol'] === 'superadmin'): ?>
                <li class="p-4 hover:bg-green-500"><a href="../superadmin/create_regional.php">Crear Regional</a></li>
                <li class="p-4 hover:bg-green-500"><a href="../superadmin/create_center.php">Crear Centro</a></li>
                <li class="p-4 hover:bg-green-500"><a href="../superadmin/create_coordinador.php">Crear Coordinador</a></li>
            <?php elseif ($_SESSION['usuario']['rol'] === 'coordinador'): ?>
                <li class="p-4 hover:bg-green-500"><a href="../coordinator/create_program.php">Crear Programa</a></li>
