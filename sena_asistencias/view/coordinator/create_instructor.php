            ...
            <?php foreach ($instructores as $instructor): ?>
                <div class="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <div class="mt-4 flex space-x-2">
                        <a href="edit_instructor.php?id=<?php echo $instructor['id']; ?>" class="text-blue-500 hover:text-blue-700">
                            <i class="fas fa-edit"></i> Editar
                        </a>
                        <a href="../../controllers/CoordinatorController.php?action=delete_instructor&id=<?php echo $instructor['id']; ?>" class="text-red-500 hover:text-red-700" onclick="return confirm('¿Estás seguro de que deseas eliminar este instructor?');">
