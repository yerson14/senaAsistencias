            ...
            <?php foreach ($regionales as $regional): ?>
                <div class="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <div class="mt-4 flex space-x-2">
                        <button onclick="window.location.href='editar_regional.php?id=<?php echo $regional['id']; ?>'" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition duration-300">
                            <i class="fas fa-edit"></i> Editar
                        </button>
                        <button onclick="if(confirm('¿Estás seguro de que deseas eliminar esta regional?')) { window.location.href='../../controllers/SuperAdminController.php?action=delete_regional&id=<?php echo $regional['id']; ?>' }" class="bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-600 transition duration-300">
